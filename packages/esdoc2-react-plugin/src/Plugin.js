...
const ParamParser = require("esdoc2/out/src/Parser/ParamParser").default;
const DocBuilder = require("esdoc2-publish-html-plugin/out/src/Builder/DocBuilder").default;
...
class Plugin {
  ...
  onHandleContent(ev) {
    ...
    // create esdoc2 properties from react props
